...
```{python package import,echo=TRUE}
import os
import sys
import cv2
import numpy as np
...
```{python import data,error=FALSE,echo=TRUE}
...
```{python parameters vs cycles,error=FALSE,results='hide',echo=TRUE}
...
```{python cucles vs energy density,error=FALSE,results='hide',echo=TRUE}
...
```{python SN curve,error=FALSE,results='hide',echo=TRUE}
...
```{python initiating_defect_features,echo=TRUE,error=FALSE}
