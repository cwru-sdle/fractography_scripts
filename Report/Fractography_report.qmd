---
title: Fatigue Fracture Surfaces
date: 2024-10-30
author:
    name: "Anthony Lino"
...
```{python parameters vs cycles,echo = FALSE,error=FALSE,results='hide'}
...
plt.show()
print("Linear regression R squared value: "+str(r_value))
```
...
```{python SN curve,echo = FALSE,error=FALSE,results='hide'}
...
```{python correlation plot,echo=FALSE,results='hide'}
